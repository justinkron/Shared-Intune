# https://github.com/rbalsleyMSFT/IntuneScripts/blob/main/ChangeIntunePrimaryUser/readme.md
...
$clientSecret ='bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb' 
$tenantId = 'ccccccccccccccccccccccccccccccccc'
